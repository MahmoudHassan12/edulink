...
import 'package:edu_link/features/profile/presentation/views/widgets/professor_profile_view_body.dart';
...
class ProfessorProfileView extends StatelessWidget {
  const ProfessorProfileView({required this.user, super.key});
  final UserEntity user;
  @override
  Scaffold build(BuildContext context) => Scaffold(
    extendBodyBehindAppBar: true,
    appBar: ProfileAppBar(user: user),
    body: ProfessorProfileViewBody(user: user),
